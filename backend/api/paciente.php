...
switch ($method) {
    case 'GET':
        // Listar pacientes (con control de acceso)
        if ($_SESSION['rol'] === 'paciente') {
            // Un paciente solo puede ver su propia info
            $sql = "SELECT u.user_id, u.nombre, u.apellido, u.correo, u.telefono, u.direccion FROM usuarios u INNER JOIN paciente p ON u.user_id = p.id_paciente WHERE u.user_id = ?";
            ...
            // Admin o psicólogo pueden ver todos
    ...
    case 'PUT':
        ...
        if ($_SESSION['rol'] !== 'admin' && $_SESSION['user_id'] != $user_id) {
